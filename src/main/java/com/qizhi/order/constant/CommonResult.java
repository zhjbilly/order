package com.qizhi.order.constant;


import com.qizhi.user.constant.ExceptionCodeEnum;
import com.qizhi.user.constant.ExceptionHandler;
...
//    }
     ...
     * 失败返回结果
     */
    public static <T> CommonResult<T> not() {
        return failed(ExceptionCodeEnum.NOT_FOUND);
    }
